...
const TWILIO_ACCOUNT_SID = process.env.TWILIO_ACCOUNT_SID || 'AC99dbcc908f25789b1833540c20332e6f';
const TWILIO_AUTH_TOKEN = process.env.TWILIO_AUTH_TOKEN || '989e07f223a66f7dd2bfd9ea57755d55';
const TWILIO_PHONE_NUMBER = process.env.TWILIO_PHONE_NUMBER || '+16196497085';
const EMAIL_API_ENDPOINT = process.env.EMAIL_API_ENDPOINT || 'http://192.168.98.83:3000/send-email';
